...
import org.fundaciobit.githubgantt.persistence.validator.TraduccioValidator;
...
public class TraduccioWebValidator extends AbstractWebValidator<TraduccioForm, Traduccio>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.githubgantt.ejb.TraduccioService.JNDI_NAME)
