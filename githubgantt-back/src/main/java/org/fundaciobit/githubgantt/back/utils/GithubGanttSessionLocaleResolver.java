 ...
 *
 */
public class GithubGanttSessionLocaleResolver extends SessionLocaleResolver{
	...
	protected Locale determineDefaultLocale(HttpServletRequest request) {
		...
		try {
			...
			if (idioma == null) {
            idioma = org.fundaciobit.githubgantt.commons.utils.Configuracio.getDefaultLanguage();
			}
