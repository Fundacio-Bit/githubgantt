 ...
 */
@Controller
public abstract class GithubGanttFilesBaseController<I extends IGenAppEntity,PK extends Object,F extends BaseForm> extends CommonFilesBaseController<I,PK,F,Fitxer>{
	...
	getFilesFormManager() {
    return new GithubGanttFilesFormManager(fitxerEjb);
  }
