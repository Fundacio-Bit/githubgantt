...
import org.fundaciobit.githubgantt.ejb.TraduccioService;
import org.fundaciobit.genapp.common.i18n.I18NException;
import org.fundaciobit.githubgantt.model.fields.TraduccioFields;
...
public class TraduccioRefList extends RefListBase
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    List<org.fundaciobit.githubgantt.model.entity.Traduccio> traduccions = traduccioEjb.select(where);
    ...
    for (org.fundaciobit.githubgantt.model.entity.Traduccio traduccio : traduccions) {
      org.fundaciobit.githubgantt.persistence.TraduccioJPA traduccioJPA = (org.fundaciobit.githubgantt.persistence.TraduccioJPA) traduccio;
      String key = String.valueOf(traduccioJPA.getTraduccioID());
      org.fundaciobit.githubgantt.persistence.TraduccioMapJPA _tm = traduccioJPA.getTraduccio(_lang);
      String value;
      if (_tm == null) {
