 ...
 * 
 */
public class GithubGanttMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof GithubGanttMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof GithubGanttMaxUploadSizeExceededException) {
          msgCode = ((GithubGanttMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
