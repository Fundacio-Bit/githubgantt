package org.fundaciobit.githubgantt.back.controller.common;
...
public class PrincipalController {
	...
	public ModelAndView canviarIdioma(HttpServletRequest request, HttpServletResponse response,
		...
		org.fundaciobit.githubgantt.back.utils.GithubGanttSessionLocaleResolver.setLocaleManually(request, idioma);		
		return new ModelAndView("principal");
	}
