...
import org.fundaciobit.githubgantt.back.form.webdb.FitxerForm;

import org.fundaciobit.githubgantt.back.validator.webdb.FitxerWebValidator;
...
public class FitxerController
    extends org.fundaciobit.githubgantt.back.controller.GithubGanttBaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = org.fundaciobit.githubgantt.ejb.FitxerService.JNDI_NAME)
  protected org.fundaciobit.githubgantt.ejb.FitxerService fitxerEjb;
