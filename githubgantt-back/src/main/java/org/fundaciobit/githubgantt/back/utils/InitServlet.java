...
import org.fundaciobit.githubgantt.hibernate.HibernateFileUtil;
import org.fundaciobit.githubgantt.logic.utils.I18NLogicUtils;
import org.fundaciobit.githubgantt.logic.utils.LogicUtils;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            if (fd == null) {
                throw new Exception("No s'ha definit la propietat de la ubicació dels fitxers ("
                        +  "org.fundaciobit.githubgantt.filesdirectory)") ;
            }
            if (!fd.exists()) {
        ...
        try {
            ...
            String[] basenames = { "missatges", // /WEB-INF/classes/
                    "logicmissatges", "genapp", "githubgantt_genapp" };
        ...
        try {
            log.info("GithubGantt Version: " + ver);
        } catch (Throwable e) {
            log.info("GithubGantt Version: " + ver);
        }
