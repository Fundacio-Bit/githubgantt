...
import org.fundaciobit.githubgantt.persistence.validator.FitxerValidator;
...
public class FitxerWebValidator extends AbstractWebValidator<FitxerForm, Fitxer>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.githubgantt.ejb.FitxerService.JNDI_NAME)
