...
import org.fundaciobit.githubgantt.persistence.validator.IdiomaValidator;
...
public class IdiomaWebValidator extends AbstractWebValidator<IdiomaForm, Idioma>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.githubgantt.ejb.IdiomaService.JNDI_NAME)
