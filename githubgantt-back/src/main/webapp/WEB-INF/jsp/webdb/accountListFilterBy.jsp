...
<un:useConstants var="AccountFields" className="org.fundaciobit.githubgantt.model.fields.AccountFields"/>
  ...
  <div id="FilterDiv" class="well formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccountFields.ACCOUNTID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="account.accountID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccountFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="account.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccountFields.USERNAME)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="account.username" var="username" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccountFields.TOKEN)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="account.token" var="token" />
              <fmt:message key="genapp.form.searchby" var="cercapertoken" >                
                 <fmt:param value="${token}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${token}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercapertoken}" path="token" />
            </div>
