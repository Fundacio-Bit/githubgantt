<%@page import="org.fundaciobit.githubgantt.logic.utils.LogicUtils"%>
<%@page import="org.fundaciobit.githubgantt.commons.utils.Configuracio"%>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        <li><fmt:message key="ajuda.viatelefon" />63030345962472</li>
                        <!-- <li><fmt:message key="ajuda.viaweb" /> http://www.help.hl/help</li> -->
                        <li><fmt:message key="ajuda.viaemail" />
                          <a href="mailto: governdigital.github@fundaciobit.org">governdigital.github@fundaciobit.org</a>
                        </li>
                    </ul>
                </div>
