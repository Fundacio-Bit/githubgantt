...
@Entity
@Table(name = "ghg_traduccio" )
@SequenceGenerator(name="TRADUCCIO_SEQ", sequenceName="ghg_traduccio_seq", allocationSize=1, initialValue=1000)
...
private static final long serialVersionUID = -326205279L;
  ...
  @ElementCollection(fetch= FetchType.EAGER, targetClass = org.fundaciobit.githubgantt.persistence.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="ghg_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")})
  @javax.persistence.MapKeyColumn(name="idiomaid")
  @ForeignKey(name="ghg_traducmap_traduccio_fk") 
  private Map<String, org.fundaciobit.githubgantt.persistence.TraduccioMapJPA> traduccions =  new HashMap<String, org.fundaciobit.githubgantt.persistence.TraduccioMapJPA>();

  public Map<String, org.fundaciobit.githubgantt.persistence.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, org.fundaciobit.githubgantt.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public org.fundaciobit.githubgantt.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (org.fundaciobit.githubgantt.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, org.fundaciobit.githubgantt.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
