...
public class IdiomaBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.githubgantt.model.dao.IIdiomaManager __idiomaManager;


  public final IdiomaValidator<IdiomaJPA> _validator;


  public IdiomaBeanValidator(org.fundaciobit.githubgantt.model.dao.IIdiomaManager __idiomaManager) { 
  ...
  public IdiomaBeanValidator(IdiomaValidator<IdiomaJPA> _validator,
     org.fundaciobit.githubgantt.model.dao.IIdiomaManager __idiomaManager) {
    this.__idiomaManager = __idiomaManager;
