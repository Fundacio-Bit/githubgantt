...
public class FitxerBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.githubgantt.model.dao.IFitxerManager __fitxerManager;


  public final FitxerValidator<FitxerJPA> _validator;


  public FitxerBeanValidator(org.fundaciobit.githubgantt.model.dao.IFitxerManager __fitxerManager) { 
  ...
  public FitxerBeanValidator(FitxerValidator<FitxerJPA> _validator,
     org.fundaciobit.githubgantt.model.dao.IFitxerManager __fitxerManager) {
    this.__fitxerManager = __fitxerManager;
