...
public class TraduccioBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.githubgantt.model.dao.ITraduccioManager __traduccioManager;


  public final TraduccioValidator<TraduccioJPA> _validator;


  public TraduccioBeanValidator(org.fundaciobit.githubgantt.model.dao.ITraduccioManager __traduccioManager) { 
  ...
  public TraduccioBeanValidator(TraduccioValidator<TraduccioJPA> _validator,
     org.fundaciobit.githubgantt.model.dao.ITraduccioManager __traduccioManager) {
    this.__traduccioManager = __traduccioManager;
