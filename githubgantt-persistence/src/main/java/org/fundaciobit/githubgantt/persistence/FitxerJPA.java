...
@Entity
@Table(name = "ghg_fitxer" )
@SequenceGenerator(name="FITXER_SEQ", sequenceName="ghg_fitxer_seq", allocationSize=1, initialValue=1000)
...
private static final long serialVersionUID = -252813913L;
  ...
  void postLoad() {
    if (threadLocal.get() != null) {
      this.encryptedFileID = org.fundaciobit.githubgantt.hibernate.HibernateFileUtil.encryptFileID(fitxerID);
    }
  }
