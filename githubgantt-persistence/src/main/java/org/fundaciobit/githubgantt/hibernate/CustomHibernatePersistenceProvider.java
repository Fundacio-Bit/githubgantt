package org.fundaciobit.githubgantt.hibernate;
		...
		if(fitxerProperties != null) {
			fitxerProperties.forEach((k,v) -> {
               String kStr = k.toString();
	        	if (kStr.startsWith("org.fundaciobit.githubgantt.hibernate")) {
	        		projecteProperties.put(kStr.replace("org.fundaciobit.githubgantt.",""), v.toString());
