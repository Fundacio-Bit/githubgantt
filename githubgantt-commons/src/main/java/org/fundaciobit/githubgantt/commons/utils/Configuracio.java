...
public class Configuracio implements Constants {
    ...
    public static Properties getFilesProperties() {
        ...
        if (fileProperties.isEmpty()) {
            ...
            // WildFly
            String propertyFile = System.getProperty(Constants.GITHUBGANTT_PROPERTY_BASE + "properties");
            File file = new File(propertyFile);
    
            String propertySystemFile = System.getProperty(Constants.GITHUBGANTT_PROPERTY_BASE + "system.properties");
    ...
    public static boolean isDesenvolupament() {
        ...
        return Boolean.parseBoolean(getProperty(GITHUBGANTT_PROPERTY_BASE + "development"));
    }

    public static boolean isCAIB() {
        return Boolean.parseBoolean(getProperty(GITHUBGANTT_PROPERTY_BASE + "iscaib"));
    }

    public static String getAppUrl() {
        return getProperty(GITHUBGANTT_PROPERTY_BASE + "url");
    }

    public static String getAppEmail() {
        return getProperty(GITHUBGANTT_PROPERTY_BASE + "email.from");
    }

    public static String getAppName() {
        return getProperty(GITHUBGANTT_PROPERTY_BASE + "name", "GithubGantt");
    }

    public static String getDefaultLanguage() {
        return getProperty(GITHUBGANTT_PROPERTY_BASE + "defaultlanguage", "ca");
    }

    public static byte[] getEncryptKey() {
        return getProperty(GITHUBGANTT_PROPERTY_BASE + "encryptkey", "0123456789123456").getBytes();
    }

    public static Long getMaxUploadSizeInBytes() {
        return Long.getLong(GITHUBGANTT_PROPERTY_BASE + "maxuploadsizeinbytes");
    }

    public static Long getMaxFitxerAdaptatSizeInBytes() {
        return Long.getLong(GITHUBGANTT_PROPERTY_BASE + "maxfitxeradaptatsizeinbytes");
    }

    public static File getFilesDirectory() {
        String path = getProperty(GITHUBGANTT_PROPERTY_BASE + "filesdirectory");
        return new File(path);
    }

    public static String getFileSystemManager() {
        return getProperty(GITHUBGANTT_PROPERTY_BASE + "filesystemmanagerclass");
    }
